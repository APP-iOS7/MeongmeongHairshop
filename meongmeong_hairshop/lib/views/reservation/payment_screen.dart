...
class PaymentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('결제 화면'), backgroundColor: Colors.green),
          ...
          return Consumer<ReservationProvider>(
            builder: (context, reservationProvider, child) {
              ...
              for (String service in reservationProvider.reservation.services) {
                totalFee +=
                    reservationProvider.prices[reservationProvider.services
                        .indexOf(service)];
              }
              ...
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${DateFormat('MM. dd (E) ', 'ko_KR').format(reservationProvider.reservation.date)} ${reservationProvider.reservation.reservedTime}',
                    ...
                    Text(
                      '${reservationProvider.reservation.designer} ${reservationProvider.position}',
                      style: TextStyle(fontSize: 15),
                    ),
                    SizedBox(height: 20),
                    ...
                    Column(
                      children: [
                        for (String service
                            in reservationProvider.reservation.services)
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${reservationProvider.prices[reservationProvider.services.indexOf(service)]}원',
                              ),
                            ],
                          ),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [Text('총금액'), Text('$totalFee원')],
                        ),
                      ],
                    ),
